package com.example.demo.erp.communication.serviceImplementation;
...
import com.example.demo.erp.communication.parsitence.repositories.SessionRepository;
...
public class WhatsAppImpl implements WhatsAppService {
    ...
    private final com.example.demo.erp.communication.parsitence.repositories.emailRepo emailRepo;

    public WhatsAppImpl(CustomerRepo customerRepo, CommunicationService communicationService, SessionRepository sessionRepository, BankAccountRepo accountRepo, com.example.demo.erp.communication.parsitence.repositories.emailRepo emailRepo) {
