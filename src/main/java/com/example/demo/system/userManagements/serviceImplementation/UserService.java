...
import com.example.demo.system.userManagements.parsitence.repositories.*;
...
public class UserService implements UserDetailsService {
  ...
  Authentication auth = SecurityContextHolder.getContext().getAuthentication();
    public UserService(com.example.demo.system.userManagements.parsitence.repositories.userRepo userRepo, com.example.demo.system.userManagements.parsitence.repositories.securityRepo securityRepo, com.example.demo.system.userManagements.parsitence.repositories.loginsRepo loginsRepo, rolesRepo roles, permissionsRepo permissions, CommunicationService communication) {
